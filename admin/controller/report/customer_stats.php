<?php
class ControllerReportCustomerStats extends Controller {
	public function index() {     
		$this->language->load('report/customer_stats');
		...
		//the part for chart ends
				 
		$this->template = 'report/customer_stats.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
