<?php
class ControllerReportRefererDetails extends Controller {
	public function index() {     
		...
		$this->data['refererdetails'] = array();
		...
		$this->data['refname'] = $this->request->get['referer'];
		$results = $this->model_report_customer->getRefereeDetails($this->request->get['referer']);
		foreach ($results as $result) {
			$this->data['refdetails'][] = array(
		...
		$this->data['column_total'] = $this->language->get('column_total');
 		...
 		$this->data['column_prodid'] = $this->language->get('column_prodid');
 		$this->data['column_prodname'] = $this->language->get('column_prodname');
 		$this->data['heading_prodref'] = $this->language->get('heading_prodref');
 		$this->data['heading_referer'] = $this->language->get('heading_referer');
 		$this->data['heading_title_ref'] = $this->language->get('heading_title_ref');
		...
		$this->template = 'report/referer_details.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
